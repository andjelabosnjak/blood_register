...
class DonationRequestsController extends Controller
{
    public function all_donation_requests(){
        ...
        $donation_requests = DonationRequests::where('approved','!=','0')->orderBy('id','desc')->get();
    ...
    public function pending_donation_requests(){
        ...
        $pending_donation_requests = DonationRequests::where('approved','=','0')->orderBy('id','desc')->get();
